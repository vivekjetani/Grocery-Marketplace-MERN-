                ...
                <div className="space-y-4">
                    ...
                    {loading ? (
                        ...
                        <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-700 p-10 text-center">
                            ...
                            <p className="text-slate-900 dark:text-white font-bold">No captains yet</p>
                            <p className="text-slate-400 text-sm mt-1">Create your first captain to get started.</p>
                        </div>
                    ) : (
